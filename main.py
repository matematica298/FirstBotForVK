...
@bot.on.chat_message(text=["Помощь","@club181612389 Помощь"])
async def hi_handler(message: Message):
    # Создаем клавиатуру
...
@bot.on.chat_message(text="@club181612389 Помощь")
async def hi_handler(message: Message):
    # Создаем клавиатуру
    KEYBOARD1 = Keyboard(one_time=True)
...
@bot.on.chat_message(text="@club181612389 Правила")
async def hi_handler(message: Message):
    # Создаем клавиатуру
    KEYBOARD1 = Keyboard(one_time=True)
...
@bot.on.chat_message(text="@club181612389 Дз на завтра")
async def hi_handler(message: Message):
    global dz
    await message.answer(dz)
